...
import { type getDashboardDataType, type UserContextType } from "../../../types";
...
export const Dashboard: React.FC = () => {
  ...
  const [ dashboardData, setDashboardData ] = useState<getDashboardDataType | null>(null);
  ...
  const prepareChartData = (data: getDashboardDataType) => {
  ...
  const getDashboardData = async () => {
    try {
      const response = await axiosInstance(API_PATHS.TASKS.GET_DASHBOARD_DATA);
      if (response.data) {
